	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="main">
			...
			<div id="of-nav">
				...
				<div class="logo">
				<h3>高级选项<span><?php echo ('版本：'. THEMEVERSION); ?></span></h3>
				</div>
						<div class="save_bar"> 
						<button id ="of_save" type="button" class="button-primary"><?php _e('Save All Changes', 'flatsome-admin');?></button>			
						<img style="display:none" src="<?php echo ADMIN_DIR; ?>assets/images/loading-bottom.gif" class="ajax-loading-img ajax-loading-img-bottom" alt="工作中..." />
