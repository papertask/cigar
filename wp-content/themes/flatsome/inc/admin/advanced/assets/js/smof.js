...
jQuery(document).ready(function($){
	...
	$(".slide_add_button").live('click', function(){		
		...
		var newSlide = '<li class="temphide"><div class="slide_header"><strong>幻灯片 ' + newNum + '</strong><input type="hidden" class="slide of-input order" name="' + sliderId + '[' + newNum + '][order]" id="' + sliderId + '_slide_order-' + newNum + '" value="' + newNum + '"><a class="slide_edit_button" href="#">编辑</a></div><div class="slide_body" style="display: none; "><label>标题</label><input class="slide of-input of-slider-title" name="' + sliderId + '[' + newNum + '][title]" id="' + sliderId + '_' + newNum + '_slide_title" value=""><label>图片URL</label><input class="upload slide of-input" name="' + sliderId + '[' + newNum + '][url]" id="' + sliderId + '_' + newNum + '_slide_url" value=""><div class="upload_button_div"><span class="button media_upload_button" id="' + sliderId + '_' + newNum + '">上传</span><span class="button remove-image hide" id="reset_' + sliderId + '_' + newNum + '" title="' + sliderId + '_' + newNum + '">删除</span></div><div class="screenshot"></div><label>链接网址（可选）</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][link]" id="' + sliderId + '_' + newNum + '_slide_link" value=""><label>描述（可选）</label><textarea class="slide of-input" name="' + sliderId + '[' + newNum + '][description]" id="' + sliderId + '_' + newNum + '_slide_description" cols="8" rows="8"></textarea><a class="slide_delete_button" href="#">删除</a><div class="clear"></div></div></li>';
	...
	$('#of_backup_button').live('click', function(){
		...
		var answer = confirm("点击确定备份当前保存的选项.")
	...
	$('#of_restore_button').live('click', function(){
		...
		var answer = confirm("'警告：您所有的当前选项将被上次备份的数据替换！ 继续？")
	...
	$('#of_reset').click(function() {
		...
		//confirm reset
		var answer = confirm("点击确定重置。所有设置都将丢失，并被默认设置取代！");
...
//四亩地				$('head').append('<link href="http://fonts.googleapis.com/css?family='+ the_font +'" rel="stylesheet" type="text/css" class="'+ _linkclass +'">');
