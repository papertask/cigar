...
Flatsome_Option::add_field( '', array(
	...
	'default'  => '<div class="options-title-divider">商店页面</div>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'label'    => __( '', 'flatsome-admin' ),
	'section'  => 'woocommerce_product_catalog',
	'default'  => '<div class="options-title-divider">分类布局</div>',
) );
...
Flatsome_Option::add_field( '', array(
    ...
    'label'       => __( '', 'flatsome-admin' ),
    'section'         => 'woocommerce_product_catalog',
    'default'     => '<button style="margin-top: 15px; margin-bottom:15px" class="button button-primary" data-to-section="woocommerce_product_images">缩略图设置 →</button>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'label'    => __( '', 'flatsome-admin' ),
	'section'  => 'woocommerce_product_catalog',
	'default'  => '<div class="options-title-divider">页眉</div>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'label'    => __( '', 'flatsome-admin' ),
	'section'  => 'woocommerce_product_catalog',
	'default'  => '<div class="options-title-divider">面包屑导航</div>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'label'    => __( '', 'flatsome-admin' ),
	'section'  => 'woocommerce_product_catalog',
	'default'  => '<div class="options-title-divider">分类框</div>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'label'    => __( '', 'flatsome-admin' ),
	'section'  => 'woocommerce_product_catalog',
	'default'  => '<div class="options-title-divider">产品框</div>',
) );
