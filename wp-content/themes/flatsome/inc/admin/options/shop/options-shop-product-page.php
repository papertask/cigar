...
Flatsome_Option::add_field( '', array(
	...
	'default'  => '<div class="options-title-divider">布局</div>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'label'    => __( '', 'flatsome-admin' ),
	'section'  => 'product-page',
	'default'  => '<div class="options-title-divider">相册</div>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'label'    => __( '', 'flatsome-admin' ),
	'section'  => 'product-page',
    'default'     => '<button style="margin-top: 15px; margin-bottom:15px" class="button button-primary" data-to-section="woocommerce_product_images">WooCommerce图片设置 →</button>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'section'         => 'product-page',
	'default'     => '<span class="description customize-control-description">默认的WooCommerce相册已被激活。多个Flatsome相册选项被禁用。</span>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'label'           => __( '', 'flatsome-admin' ),
	'section'         => 'product-page',
    'default'     => '<div class="options-title-divider">产品概述</div>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'label'    => __( '', 'flatsome-admin' ),
	'section'  => 'product-page',
    'default'     => '<div class="options-title-divider">选项卡</div>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'label'    => __( '', 'flatsome-admin' ),
	'section'  => 'product-page',
    'default'     => '<div class="options-title-divider">添加到购物车</div>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'label'    => __( '', 'flatsome-admin' ),
	'section'  => 'product-page',
    'default'     => '<div class="options-title-divider">相关/追加销售</div>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'label'    => __( '', 'flatsome-admin' ),
	'section'  => 'product-page',
    'default'     => '<div class="options-title-divider">自定义HTML</div>',
) );
