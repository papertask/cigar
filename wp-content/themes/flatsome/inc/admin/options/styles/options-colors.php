...
Flatsome_Option::add_field( '', array(
    ...
    'section'     => 'colors',
    'default'     => '<div class="options-title-divider">主要颜色</div>',
) );
...
Flatsome_Option::add_field( '', array(
    ...
    'label'       => __( '', 'flatsome-admin' ),
    'section'     => 'colors',
    'default'     => '<div class="options-title-divider">类型</div>',
) );
...
Flatsome_Option::add_field( '', array(
    ...
    'label'       => __( '', 'flatsome-admin' ),
    'section'     => 'colors',
    'default'     => '<div class="options-title-divider">链接</div>',
) );
...
if(is_woocommerce_activated()){
    Flatsome_Option::add_field( '', array(
        ...
        'label'       => __( '', 'flatsome-admin' ),
        'section'     => 'colors',
        'default'     => '<div class="options-title-divider">商店颜色</div>',
    ) );
