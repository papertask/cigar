...
Flatsome_Option::add_field( '', array(
	...
	'label'    => '',
	'section'  => 'footer',
	'default'  => '<div class="options-title-divider"  style="margin-bottom:15px">自定义页脚</div>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'default'         => '<div class="options-title-divider" style="margin-bottom:15px">小工具</div><p>点击按钮转到页脚小工具</p><div><button style="margin-bottom:15px" class="button button-primary" data-to-panel="widgets">编辑页脚小工具</button></div>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'active_callback' => $hide_on_custom_footer_block,
	'section'         => 'footer',
	'default'         => '<div class="options-title-divider">页脚1</div>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'label'           => '',
	'section'         => 'footer',
	'default'         => '<div class="options-title-divider">页脚2</div>',
	'active_callback' => $hide_on_custom_footer_block,
) );
...
Flatsome_Option::add_field( 'option', array(
	...
	'default'           => '版权所有 [ux_current_year] &copy; <strong>Wordpress主题</strong>',
) );
...
Flatsome_Option::add_field( '', array(
	...
	'label'           => '',
	'section'         => 'footer',
	'default'         => '<div class="options-title-divider">返回顶部按钮</div>',
) );
