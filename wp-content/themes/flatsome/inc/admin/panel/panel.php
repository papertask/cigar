...
//四亩地		add_submenu_page('flatsome-panel', 'Theme License', 'Theme License', 'manage_options', 'admin.php?page=flatsome-panel' );
		...
		add_submenu_page('flatsome-panel', 'Help & Guides', '帮助和指导', 'manage_options', 'flatsome-panel-support', array( $this, 'flatsome_panel_support') );

		//add_submenu_page('flatsome-panel', 'Plugins', 'Plugins', 'manage_options', 'flatsome-panel-plugins', array( $this, 'flatsome_panel_plugins') );

		add_submenu_page('flatsome-panel', 'Change log', '更新日志', 'manage_options', 'flatsome-panel-changelog', array( $this, 'flatsome_panel_changelog') );
	...
	public function flatsome_panel_welcome() {
		...
		<div class="flatsome-panel">
			<div class="wrap about-wrap">
				...
				<?php //四亩地 require_once( get_template_directory() . '/inc/admin/panel/sections/tab-activate.php' ); ?>
			</div>
		</div>
		<?php
	}
