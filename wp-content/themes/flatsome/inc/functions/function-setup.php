...
function flatsome_setup() {
  ...
  load_theme_textdomain( 'flatsome', get_stylesheet_directory() . '/languages1599' );

	/* load theme languages */
  load_theme_textdomain( 'flatsome', get_template_directory() . '/languages1599' );
	load_theme_textdomain( 'flatsome-admin', get_template_directory() . '/languages1599' );
	load_theme_textdomain( 'envato_setup', get_template_directory() . '/languages1599' );
	load_theme_textdomain( 'tgmpa', get_template_directory() . '/languages1599' );
	load_theme_textdomain( 'wordpress-importer', get_template_directory() . '/languages1599' );
	load_theme_textdomain( 'wordpress', get_template_directory() . '/languages1599' );
	load_theme_textdomain( 'ux-builder', get_template_directory() . '/languages1599' );
	load_theme_textdomain( 'blocks', get_template_directory() . '/languages1599' );
	load_theme_textdomain( 'woocommerce', get_template_directory() . '/languages1599' );
...
function flatsome_scripts() {
	...
	if ( ! empty( $maps_api ) ) {
		wp_register_script( 'flatsome-maps', '//ditu.google.cn/maps/api/js?key=' . $maps_api, array( 'jquery' ), $version, true );
	}
