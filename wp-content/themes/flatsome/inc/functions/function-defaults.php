...
if(!function_exists('flatsome_defaults')){
  function flatsome_defaults($option) {
    $df = array(
      ...
      'topbar_left' => '<strong class="uppercase">添加任何东西到这里或者删除它...</strong>',
      ...
      'type_headings' => array('font-family'=> '微软雅黑','variant' => '700'),
      'type_texts' => array('font-family'=> '微软雅黑','variant' => '400'),
      'type_nav' => array('font-family'=> '微软雅黑','variant' => '700'),
      'type_alt' => array('font-family'=> '微软雅黑'),
      ...
      'blog_show_excerpt' => 1,
      'wc_account_links' => 1,
      'footer_left_text' => '版权所有 [ux_current_year] &copy; <strong>四亩地</strong>', // Sanitaize
