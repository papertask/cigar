...
add_action( 'current_screen', function ( $screen ) {
  ...
  wp_die( "<em>$post->post_type</em>文章类型不适用于四亩地生成器." );
} );
...
add_action( 'media_buttons', function () {
  echo '<button type="button" onclick="uxBuilderHide()" class="button button-primary"><span class="dashicons dashicons-yes"></span>确定</button>';
  echo '<button type="button" onclick="uxBuilderDiscard()" class="button"><span class="dashicons dashicons-no-alt"></span>取消</button>';
