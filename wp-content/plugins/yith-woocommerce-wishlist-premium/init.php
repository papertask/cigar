<?php
/**
 * Plugin Name: YITH WooCommerce收藏夹高级版
 * Plugin URI: https://yithemes.com/themes/plugins/yith-woocommerce-wishlist/
* Description: WooCommerce收藏夹插件高级版，可以把产品添加到收藏夹中。更多WordPress汉化主题、主题升级、问题咨询请访问：<strong><a href="http://www.4mudi.com">http://www.4mudi.com</a></strong>或者光临<a href="http://wordpresszhuti.taobao.com">四亩地淘宝店</a>
 * Version: 2.2.8
 * Author: YITH
...
if( ! function_exists( 'yith_wishlist_constructor' ) ) {
    function yith_wishlist_constructor() {
        ...
        load_plugin_textdomain( 'yith-plugin-fw', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
