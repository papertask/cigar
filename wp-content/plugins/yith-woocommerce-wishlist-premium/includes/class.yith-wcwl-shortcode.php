		...
		public static function register_gutenberg_blocks() {
			$blocks = array(
				'yith-wcwl-add-to-wishlist' => array(
					...
					'title'          => _x( 'YITH添加到收藏夹', '[gutenberg]: block name', 'yith-woocommerce-brands-add-on' ),
					'description'    => _x( '显示添加到收藏夹按钮', '[gutenberg]: block description', 'yith-woocommerce-brands-add-on' ),
					'shortcode_name' => 'yith_wcwl_add_to_wishlist',
					'attributes'     => array(
						'product_id'  => array(
							'type'    => 'text',
							'label'   => __( '要添加到收藏夹产品的ID（留空以使用全局产品）', 'yith-woocommerce-brands-add-on' ),
							'default' => '',
						),
						'wishlist_url'  => array(
							'type'    => 'text',
							'label'   => __( '收藏夹页面URL（留空以使用默认值）', 'yith-woocommerce-brands-add-on' ),
							'default' => '',
						),
						'label'  => array(
							'type'    => 'text',
							'label'   => __( '按钮标签（留空以使用默认值）', 'yith-woocommerce-brands-add-on' ),
							'default' => '',
						),
						'browse_wishlist_text'  => array(
							'type'    => 'text',
							'label'   => __( '“浏览收藏夹”标签（留空以使用默认值）', 'yith-woocommerce-brands-add-on' ),
							'default' => '',
						),
						'already_in_wishslist_text'  => array(
							'type'    => 'text',
							'label'   => __( '“产品已在收藏夹”标签（留空以使用默认值）', 'yith-woocommerce-brands-add-on' ),
							'default' => '',
						),
						'product_added_text'  => array(
							'type'    => 'text',
							'label'   => __( '“产品已添加到收藏夹”标签（留空以使用默认值）', 'yith-woocommerce-brands-add-on' ),
							'default' => '',
						),
						'icon'  => array(
							'type'    => 'text',
							'label'   => __( '按钮的图标（使用任何FontAwesome有效类，或留空以使用默认值）', 'yith-woocommerce-brands-add-on' ),
							'default' => '',
						),
						'link_classes'  => array(
							'type'    => 'text',
							'label'   => __( '按钮的其他css类（留空以使用默认值）', 'yith-woocommerce-brands-add-on' ),
							'default' => '',
						),
					),
				),
				'yith-wcwl-wishlist' => array(
					'style'          => 'yith-wcwl-main',
					'script'         => 'jquery-yith-wcwl',
					'title'          => _x( 'YITH收藏夹', '[gutenberg]: block name', 'yith-woocommerce-brands-add-on' ),
					'description'    => _x( '显示收藏夹中的产品列表', '[gutenberg]: block description', 'yith-woocommerce-brands-add-on' ),
					'shortcode_name' => 'yith_wcwl_wishlist',
					'attributes'     => array(
						'pagination'    => array(
							'type'    => 'select',
							'label'   => __( '选择是否对收藏夹中的项目进行分页或全部显示', 'yith-woocommerce-brands-add-on' ),
							'default' => 'no',
							'options' => array(
						...
						'per_page'    => array(
							'type'    => 'number',
							'label'   => __( '每页显示的项目数', 'yith-woocommerce-brands-add-on' ),
							'default' => '5',
						),
						'wishlist_id'  => array(
							'type'    => 'text',
							'label'   => __( '要显示的收藏夹ID（例如：K6EOWXB888ZD）', 'yith-woocommerce-brands-add-on' ),
							'default' => '',
						),
					),
				),
